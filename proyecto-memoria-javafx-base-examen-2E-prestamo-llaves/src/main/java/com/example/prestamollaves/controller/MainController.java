...
public class MainController {
    ...
    @FXML
    public void agregar() {
        String mensajeError = service.agregar(
    ...
    public void actualizar() {
        if (nombreOriginal == null) {
            mostrarMensaje("Error", "Seleccione un registro para actualizar.", Alert.AlertType.WARNING);
            return;
        }

        String mensajeError = service.actualizar(
                nombreOriginal,
                txtNombreSolicitante.getText(),
                txtSalon.getText(),
                cbTurno.getValue()
    ...
    public void eliminar() {
        ...
        String mensajeError = service.eliminar(nombreAEliminar);
